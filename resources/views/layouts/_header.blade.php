                ...
                @else
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                            <span class="user-avatar pull-right" style="margin-right:8px;margin-top:-5px;">
                                <img src="{{ Auth::user()->avatar }}" alt="avatar" class="img-responsive img-circle" width="30px" height="30px">
                            </span>
